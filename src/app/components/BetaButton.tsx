          ...
          >
            ...
            <ol className="space-y-4 text-black/70">
              <li className="flex gap-3">
                ...
                <div>
                  <p>Get Apple's <a href={TESTFLIGHT_APP_URL} target="_blank" rel="noopener noreferrer" className="text-[#756F63] hover:text-[#5a554b] font-medium underline">TestFlight</a> app from the App Store if you don't have it</p>
                </div>
              </li>
